...
export const FriendsListScreen: React.FC<FriendsListScreenProps> = ({
  ...
  const renderSearchResultItem = (player: SocialPlayer) => {
    ...
    return (
      ...
      >
        <View style={styles.friendAvatar}>
          <View
            style={[styles.avatarContainer, { backgroundColor: player.avatar.backgroundColor }]}
          >
  ...
  return (
    <LinearGradient colors={[colorScheme.primary, colorScheme.secondary]} style={styles.container}>
        ...
        {[
          ...
          >
            <Text style={[styles.tabText, activeTab === tab.key && styles.activeTabText]}>
              {tab.label}
              {tab.count > 0 && <Text style={styles.tabBadge}> ({tab.count})</Text>}
            </Text>
          </TouchableOpacity>
        ))}
      </View>
