...
export class MysteryBalloonManager {
  ...
  private rewardTemplates: Record<MysteryRewardType, MysteryReward[]> = {} as Record<
    MysteryRewardType,
    MysteryReward[]
  >;
  ...
  private createDefaultConfig(): MysteryBalloonConfig {
    return {
      ...
      spawnRateProgression: [0.05, 0.06, 0.07, 0.08, 0.09, 0.1, 0.11, 0.12, 0.13, 0.15],
      minSpawnInterval: 8,
      maxSpawnInterval: 25,
    ...
    this.rewardTemplates = {
      coins: [
        ...
        // Uncommon coins (25% of coin rewards)
        {
          ...
          announcementText: '+100 Coins!',
          particleEffect: 'coin_burst',
        },
        {
          id: 'coins_medium_2',
          type: 'coins',
        ...
        // Rare coins (12% of coin rewards)
        {
          ...
          announcementText: '+250 Coins!',
          particleEffect: 'coin_explosion',
        },
        {
          id: 'coins_large_2',
          type: 'coins',
        ...
        // Epic coins (2.5% of coin rewards)
        {
          ...
          announcementText: '+750 COINS!',
          particleEffect: 'coin_fountain',
        },
        ...
        // Legendary coins (0.5% of coin rewards)
        {
          ...
          scalingFactor: 1.5,
          celebrationIntensity: 'spectacular',
          announcementText: 'JACKPOT! +1500 COINS!',
          particleEffect: 'coin_jackpot',
        },
      ],
      ...
      experience: [
        {
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'subtle',
          announcementText: '+50 XP',
          particleEffect: 'xp_glow',
        },
        {
          id: 'xp_medium',
          type: 'experience',
          ...
          scalingFactor: 1.1,
          celebrationIntensity: 'medium',
          announcementText: '+100 XP',
          particleEffect: 'xp_burst',
        },
        {
          id: 'xp_large',
          type: 'experience',
          ...
          scalingFactor: 1.2,
          celebrationIntensity: 'dramatic',
          announcementText: '+200 XP!',
          particleEffect: 'xp_explosion',
        },
        {
          id: 'xp_huge',
          type: 'experience',
          ...
          scalingFactor: 1.3,
          celebrationIntensity: 'spectacular',
          announcementText: '+500 XP!',
          particleEffect: 'xp_fountain',
        },
      ],
      ...
      customization: [
        {
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'medium',
          announcementText: 'New Color Unlocked!',
          particleEffect: 'rainbow_burst',
        },
        {
          id: 'trail_unlock',
          type: 'customization',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'dramatic',
          announcementText: 'New Trail Unlocked!',
          particleEffect: 'trail_sparkle',
        },
        {
          id: 'effect_unlock',
          type: 'customization',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'spectacular',
          announcementText: 'Special Effect Unlocked!',
          particleEffect: 'effect_burst',
        },
        {
          id: 'legendary_unlock',
          type: 'customization',
          value: 'legendary_cosmetic',
          rarity: 'legendary',
          baseDropRate: 0.005,
          scalingFactor: 1.0,
          celebrationIntensity: 'spectacular',
          announcementText: 'LEGENDARY COSMETIC!',
          particleEffect: 'legendary_explosion',
        },
      ],
      ...
      score_multiplier: [
        {
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'medium',
          announcementText: '2x Score Boost!',
          particleEffect: 'score_glow',
        },
        {
          id: 'score_3x',
          type: 'score_multiplier',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'dramatic',
          announcementText: '3x Score Boost!',
          particleEffect: 'score_burst',
        },
        {
          id: 'score_5x',
          type: 'score_multiplier',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'spectacular',
          announcementText: '5x SCORE BOOST!',
          particleEffect: 'score_explosion',
        },
        {
          id: 'score_10x',
          type: 'score_multiplier',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'spectacular',
          announcementText: '10x MEGA BOOST!',
          particleEffect: 'score_mega',
        },
      ],
      ...
      mystery_box: [
        {
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'medium',
          announcementText: 'Mystery Box!',
          particleEffect: 'mystery_glow',
        },
        {
          id: 'mystery_rare',
          type: 'mystery_box',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'dramatic',
          announcementText: 'Rare Mystery Box!',
          particleEffect: 'mystery_burst',
        },
        {
          id: 'mystery_epic',
          type: 'mystery_box',
          ...
          scalingFactor: 1.0,
          celebrationIntensity: 'spectacular',
          announcementText: 'Epic Mystery Box!',
          particleEffect: 'mystery_explosion',
        },
        {
          id: 'mystery_legendary',
          type: 'mystery_box',
          value: 'legendary_box',
          rarity: 'legendary',
          baseDropRate: 0.01,
          scalingFactor: 1.0,
          celebrationIntensity: 'spectacular',
          announcementText: 'LEGENDARY MYSTERY!',
          particleEffect: 'mystery_legendary',
        },
      ],
